    ...
    <label class="mr-sm-2" for="inlineFormCustomSelect">الآية</label>
      <select class="custom-select mr-sm-2" id="inlineFormCustomSelect">
        ...
        <option value="3">3</option>
                    ...
                    <div class="wrap-input100 bg1 mem-option">
                    <div class="container" style="font-family:'Adobe Arabic'; font-size:15px;">
	<div class="row" style="display:inline-block; float:center;">
		<div class="new"  style="float: right; margin:5px;">
        <span>أيام الحفظ</span>

  <form>
    <div class="form-group">
    <label for="html">الأحد</label>
      <input type="checkbox" id="html">
    </div>
    <div class="form-group">
    <label for="css">الإثنين</label>
      <input type="checkbox" id="css">
    </div>
    <div class="form-group">
    <label for="javascript">الثلاثاء</label>
      <input type="checkbox" id="javascript">
    </div>
    <div class="form-group">
    <label for="javascript">الأربعاء</label>
      <input type="checkbox" id="javascript">
    </div>
    <div class="form-group">
    <label for="javascript">الخميس</label>
      <input type="checkbox" id="javascript">
    </div>
    <div class="form-group">
    <label for="javascript">الجمعة</label>
      <input type="checkbox" id="javascript">
    </div>
    <div class="form-group">
    <label for="javascript">السبت</label>
      <input type="checkbox" id="javascript">
    </div>
  </form>
</div>
