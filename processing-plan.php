...
<!--End of Header-->
<table class="table table-striped table-light"  style="padding:20px; text-align:center;">
  <thead>
    <tr>
      <th scope="col" style="text-align:center;">الآيات</th>
      <th scope="col" style="text-align:center;">التاريخ</th>
      <th scope="col" style="text-align:center;">اليوم</th>
      <th scope="col" style="text-align:center;">السورة</th>
...
<div style="width:100%; height:40px; background-color:#e6e6e6; display:inline-block; position:relative; float:right;">
<a href="" style="display:inline-block; position:relative; float:right; margin:5px; margin-right:20px;"><img src="images/icons/download.png" style="width:20px; height:20px; background-color:#e6e6e6;"></a>
</div>
	<!--===============================================================================================-->
